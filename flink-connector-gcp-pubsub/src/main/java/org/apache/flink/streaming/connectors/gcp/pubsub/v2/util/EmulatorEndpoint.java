...
public class EmulatorEndpoint {
    ...
    @Nullable
    public static String getEmulatorEndpoint(@Nullable String endpoint) {
        ...
        if (endpoint != null && endpoint.startsWith(EMULATOR_ENDPOINT_PREFIX)) {
            return endpoint.replaceFirst(EMULATOR_ENDPOINT_PREFIX, "");
        }
        return emulatorEndpoint;
    }
}
